                ...
                <div class="card2 card border-0 px-4 px-sm-5 py-5">
                    <small class="text-right mb-3">
                        <a href="<?= base_url('auth'); ?>">
                            <u>Sudah punya akun ? Login aja !</u>
                        </a>
                    </small>
                    ...
                    <form action="<?= base_url('auth/registration'); ?>" method="POST">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                </label> <input type="text" id="name" name="name" placeholder="Enter Full Name . . ." value="<?= set_value('name'); ?>">
                                <small class="text-danger pl-3" style="font-size: 10px;"><?= form_error('name') ?></small>
                            </div>
                        </div>
                        <div class="row px-3">
                            <label class="mb-0">
                                <h6 class="mb-0 text-sm">Email</h6>
                            </label> <input type="email" name="email" id=email placeholder="Enter Email Address . . ." value="<?= set_value('email'); ?>">
                            <small class="text-danger" style="font-size: 10px;"><?= form_error('email') ?></small>
                        </div>
                        <div class="row px-3">
                            <label class="mb-0">
                            ...
                            <small class="text-danger" style="font-size: 10px;"><?= form_error('password1') ?></small>
                        </div>
                        <div class="row px-3">
                            <label class="mb-0">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="row px-3">
                                    <label class="mb-0">
                                        <h6 class="mb-0 text-sm">No. Telpon</h6>
                                    </label> <input type="text" name="telp" id="telp" placeholder="Enter No Telpon . . ." value="<?= set_value('no_telp'); ?>">
                                    <small class="text-danger" style="font-size: 10px;"><?= form_error('telp') ?></small>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="row px-3">
                                    <label class="mb-0">
                                        <h6 class="mb-0 text-sm">No. Identitas Laundry</h6>
                                    </label>
                                    <span toggle="#password-field" class="fa fa-fw fa-eye field_icon toggle-id-entitas"></span>
                                    <input type="number" name="id_entitas" id="id_entitas" placeholder="Enter Identitas . . .">
                                    <small class="text-danger" style="font-size: 10px;"><?= form_error('id_entitas') ?></small>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="row px-3">
                                    <label class="mb-0">
                                        <h6 class="mb-0 mt-1 text-sm">Daftar Sebagai : </h6>
                                    </label>
                        ...
                        <div class="row px-3 mb-3 mt-2"> <small class="text-muted">Dengan mendaftar kamu setuju akan <a href="#" class="text-primary">Kebijakan</a> dan <a href="#" class="text-primary">Ketentuan</a> Serta <small style="font-size: 12px; color:red;">Diharuskan memiliki No. Identitas yang sama antara Admin dan Manajer jika satu Laundry</small>

                        </div>
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-info text-center mb-1 p">
                                    Buat Akun
                                </button>
                            </div>
                    </form>
